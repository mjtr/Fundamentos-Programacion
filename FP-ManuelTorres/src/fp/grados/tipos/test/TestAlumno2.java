...
public class TestAlumno2 {
	...
	private static void testConstructorNormal2() {
		...
		Alumno a = new AlumnoImpl2("12345678Z", "Juan", "Nadie Nadie",
	...
	private static void testSetEmailNormal() {
		...
		Alumno a = new AlumnoImpl2("12345678Z", "Pepe", "Ruiz Rodriguez",
	...
	private static void testSetEmailExcepcion() {
		...
		Alumno a = new AlumnoImpl2("12345678Z", "Manuel", "Santiago Segura",
				LocalDate.of(1950, 3, 15), "juan.nadie@alum.us.es");
...
private static void testEvaluaAlumno1Excepcion(){
	...
	Asignatura b = new AsignaturaImpl("Circuitos Electronicos",
			"2050401", 6.0, TipoAsignatura.PRIMER_CUATRIMESTRE, 1,null);
	
	a.matriculaAsignatura(asig);
	a.matriculaAsignatura(b);

	
	testEvaluaAlumno(a,asig, 2005,Convocatoria.PRIMERA, 9.0,true);
	testEvaluaAlumno(a,asig, 2005,Convocatoria.SEGUNDA, 6.0,false);
	testEvaluaAlumno(a,b, 2005,Convocatoria.SEGUNDA, 6.0);
	...
	private static void testConstructor(String dni, String nombre,
		...
		try {
			Alumno a = new AlumnoImpl2(dni, nombre, apellidos, fechaNacimiento,
					email);
			mostrarAlumno(a);
	...
	private static void mostrarAlumno(Alumno a) {
		...
		System.out.println("\tSortedMap de Asignatura y Calificacion: " + a.getCalificacionPorAsignatura());
