...
public class TestProfesor {
	...
	private static void testBorraTutoria1() {
		...
		Profesor r = new ProfesorImpl("12345678Z", "Juan", "Nadie Nadie", 
	...
	private static void testBorraTutoria2() {
		...
		Profesor r = new ProfesorImpl("12345678Z", "Antonio", "Valdés Ramírez", 
...
private static void tesBorraTodasTutorias(){
	...
	Profesor r = new ProfesorImpl("12345678Z", "Anabelén", "García Núñez", 
